...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pcdsutils-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9279&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pcdsutils-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pcdsutils` can be installed with:

```
conda install pcdsutils
```

It is possible to list all of the versions of `pcdsutils` available on your platform with:
